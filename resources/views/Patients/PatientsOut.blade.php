...
<div class="row">
	<div class="col-lg-12">
		<div class="card-box">
            ...
            <div class="row">
            <div class="col-sm-6">
					<form role="form" action="{{route('searchPatientOut')}}" method="GET">
						<div class="form-group contact-search m-b-30">
							<input type="text" id="search" class="form-control" name="searchPatientOut" placeholder="Search...">
            ...
            <div class="row">
            <div class="col-sm-6 ">
            <h3>All patients that were discharged</h3>  
             </div>
			</div>
